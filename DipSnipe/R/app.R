...
ui <- dashboardPage(
  ...
  dashboardBody(
    tags$head(
      tags$link(rel = "icon", type = "image/svg+xml", href = "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect x='1' y='1' width='30' height='30' rx='6' fill='rgb(26,26,26)' stroke='rgb(239,68,68)' stroke-width='2'/><g transform='translate(4,4)' fill='none' stroke='rgb(239,68,68)' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'><path d='M16 17h6v-6'/><path d='m22 17-8.5-8.5-5 5L2 7'/></g></svg>"),
      tags$style(HTML("
